...
func FmtNoHeader(width int, selected bool) string {
	if selected {
...
func FmtHeader(title string, width int, selected bool) string {
	if selected {
...
func FmtKeymap(control, title string, selected bool) string {
	if selected {
